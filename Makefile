...
AbbeyGrange:
	sh jena.sh --data data/AbbeyGrange-merged.ttl --query queries/query5.sparql | head
	sh jena.sh --data data/AbbeyGrange-merged.ttl --query queries/query6.sparql

ResidentPatient:
	sh jena.sh --data data/ResidentPatient-merged.ttl --query queries/query5.sparql | head
	sh jena.sh --data data/ResidentPatient-merged.ttl --query queries/query6.sparql

SilverBlaze:
	sh jena.sh --data data/SilverBlaze-merged.ttl --query queries/query5.sparql | head
	sh jena.sh --data data/SilverBlaze-merged.ttl --query queries/query6.sparql
...
data/AddMotivation.ttl : data/expand.ttl
	java -cp build/libs/Challenge2023-all.jar com.fujitsu.labs.challenge2019.AddMotivationKt data/expand.ttl > data/AddMotivation.ttl

clustering1:
	java -cp build/libs/Challenge2023-all.jar com.fujitsu.labs.challenge2019.ClusteringKt data/SpeckledBand.ttl data/expand-vector.bin

clustering0:
	java -cp build/libs/Challenge2023-all.jar com.fujitsu.labs.challenge2019.ClusteringKt data/ACaseOfIdentity.ttl data/expand-vector.bin
...
data/ExpandSituation.ttl: data/merged.ttl data/merged-vector.bin
	java -cp build/libs/Challenge2023-all.jar com.fujitsu.labs.challenge2019.ExpandSituationKt data/merged.ttl data/merged-vector.bin | tail -n +3 > data/ExpandSituation.ttl
...
data/SpeckledBand-RelatedWords.ttl: data/SpeckledBand.ttl
	java -cp build/libs/Challenge2023-all.jar com.fujitsu.labs.challenge2019.OpenNLPKt data/SpeckledBand.ttl > data/SpeckledBand-RelatedWords.ttl

# ACaseOfIdentity

data/ACaseOfIdentity-vector.bin: data/ACaseOfIdentity-merged.ttl
	java -jar libs/transe-all.jar  -s data/ACaseOfIdentity-vector.bin data/ACaseOfIdentity-merged.ttl >> ACaseOfIdentity-learn.log
...
data/ACaseOfIdentity-RelatedWords.ttl: data/ACaseOfIdentity.ttl
	java -cp build/libs/Challenge2023-all.jar com.fujitsu.labs.challenge2019.OpenNLPKt data/ACaseOfIdentity.ttl > data/ACaseOfIdentity-RelatedWords.ttl
...
data/CrookedMan-RelatedWords.ttl: data/CrookedMan.ttl
	java -cp build/libs/Challenge2023-all.jar com.fujitsu.labs.challenge2019.OpenNLPKt data/CrookedMan.ttl > data/CrookedMan-RelatedWords.ttl
...
data/DancingMen-RelatedWords.ttl: data/DancingMen.ttl
	java -cp build/libs/Challenge2023-all.jar com.fujitsu.labs.challenge2019.OpenNLPKt data/DancingMen.ttl > data/DancingMen-RelatedWords.ttl
...
data/DevilsFoot-RelatedWords.ttl: data/DevilsFoot.ttl
	java -cp build/libs/Challenge2023-all.jar com.fujitsu.labs.challenge2019.OpenNLPKt data/DevilsFoot.ttl > data/DevilsFoot-RelatedWords.ttl

# AbbeyGrange

data/AbbeyGrange-vector.bin: data/AbbeyGrange-merged.ttl
...
data/ResidentPatient-vector.bin: data/ResidentPatient-merged.ttl
...
data/SilverBlaze-vector.bin: data/SilverBlaze-merged.ttl
...
data/MeanWordnet.ttl: MeanWords.txt
	java -cp build/libs/Challenge2023-all.jar com.fujitsu.labs.challenge2019.MotivationWordnetKt MeanWords.txt | sed -e s/motivation_of_murder/way_of_mean/g -e s/motivation/mean/g > data/MeanWordnet.ttl

MeanWords.txt:
	java -cp build/libs/Challenge2023-all.jar com.fujitsu.labs.challenge2019.MeanKt | tail -n +2 > MeanWords.txt

data/MotivationWordnet.ttl: MotivationWords.txt
	java -cp build/libs/Challenge2023-all.jar com.fujitsu.labs.challenge2019.MotivationWordnetKt > data/MotivationWordnet.ttl

MotivationWords.txt:
	java -cp build/libs/Challenge2023-all.jar com.fujitsu.labs.challenge2019.MotivationKt | tail -n +2 > MotivationWords.txt
